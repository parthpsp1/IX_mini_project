...
namespace MiniProjectBackendAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IEmployerDA, EmployerDA>();
            services.AddTransient<IEmployerService, EmployerService>();

            services.AddTransient<IJobDA, JobDA>();
            services.AddTransient<IJobService, JobService>();

            services.AddTransient<IJobsAppliedDA, JobsAppliedDA>();
            services.AddTransient<IJobsAppliedService, JobsAppliedService>();

            //Adding Swagger Documentation UI
            services.AddSwaggerGen(swagger =>
            {
                swagger.SwaggerDoc("v1", new OpenApiInfo { Title = "JobProfileAPI", Version = "v1" });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "MiniProjectBackendAPI v1"));
            }
